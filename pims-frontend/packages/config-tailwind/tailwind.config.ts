...
const config = {
  ...
  safelist: [
    {
      pattern:
        /(bg|text)-color-(GOLD|TOMATO|PINK|AMBER|BLUE|LIME|ORANGE|PRIMARY)/,
    },
  ],
  theme: {
    container: {
    ...
    extend: {
      colors: {
        ...
        status: {
          ...
          'positive-hover': 'var(--status-positive-hover)',
        },
        text: {
        ...
        bgcustom: {
          violet: 'var(--bg-custom-violet)',
          amber: 'var(--bg-custom-amber)',
          orange: 'var(--bg-custom-orange)',
          crimson: 'var(--bg-custom-crimson)',
          teal: 'var(--bg-custom-teal)',
          lime: 'var(--bg-custom-lime)',
          blue: 'var(--bg-custom-blue)',
          sand: 'var(--bg-custom-sand)',
        },
        textcustom: {
          violet: 'var(--text-custom-violet)',
          amber: 'var(--text-custom-amber)',
          orange: 'var(--text-custom-orange)',
          crimson: 'var(--text-custom-crimson)',
          teal: 'var(--text-custom-teal)',
          lime: 'var(--text-custom-lime)',
          blue: 'var(--text-custom-blue)',
          sand: 'var(--text-custom-sand)',
        },
      },
      borderRadius: {
        lg: 'var(--radius)',
