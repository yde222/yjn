...
*/
  ...
  Lang: {
    ...
    Alert: {
      ...
      V12_0: '',
      FormulaCircularAsk:
        'Formula contains circular cell reference\u000ADo you want to permit it?',
      ...
      LoadSheetErrorMissingModule:
        'Loading data failed because of missing TreeGrid module %1',
      StripHtml:
        'The change will strip formatting from the text!\u000ADo you want to save the change?',
      V14_0: '',
      DownloadSync:
        'This action requires to download all data to client.\u000AIt can take longer time!\u000ADo you want to proceed?',
      V15_0: '',
      ImgData: 'image',
      ImgWidth: 'W',
      ImgHeight: 'H',
      ...
      LinkText: 'TEXT',
      ReplaceDefinedName:
        "The name '%1' already exists with value '%2'!\u000ADo you want to replace it?",
    ...
    Text: {
      ...
      Items: 'Items %d - %d',
      Print:
        '<h2><center>Please wait while generating report for printing ...</center></h2>',
      V4_7: '',
      SearchMethodList:
      ...
      ExportFinished:
        '<center><b>Report generated</b><br/><br/>Click button for download<br/></center><br/>',
      ...
      CopySlow:
        'The copy action took too long time (%d ms), please press the Ctrl+C again to finish the action',
      ...
      DiscardSheet:
        'Do you want to discard all your data and load the data from file <b>%1</b>?',
      AddSheet:
        'Do you want to add the data from file <b>%1</b> to actual data?',
      OpenSheet:
        'Do you want to add the data from file <b>%1</b> to actual data<br>or discard all your data and load the data from file <b>%1</b>?',
      ...
      UniqueSheet: ' (%1)',
      ShrinkSize:
        'There is not enough space to display the grid fully<br>Do you want to shrink the grid style size?',
      EnterFormat: 'Enter format string like in MS Excel',
      FormulaError8:
        'External reference to unknown sheet <b>%2</b> in formula <b>%1</b>',
      FormulaError9: 'Not supported function <b>%2</b> in formula <b>%1</b>',
      FormulaError10:
        'Not supported reference to external file <b>%2</b> in formula <b>%1</b>',
      FormulaError11:
        'Not yet implemented array formula or unexpected cell range <b>%2</b> in formula <b>%1</b>',
      V13_1: '',
      ...
      NaNAskReject:
        'The entered value is incorrect, do you want to discard it?',
      V14_0: '',
      ...
      FormulaErrorTimeout:
        "<span style='color:red;'>Calculation timeout expired! Not all formulas were calculated!</span><br><br>",
      PageRows: '%1 - %2',
    ...
    Gantt: {
      ...
      GanttCorrectDependencies:
        'There are also <b>%d</b> dependent tasks that should be updated. <br>Do you want to move them?',
      GanttCorrectDependency:
        'There is also one dependent task that should be updated. Do you want to move it?',
      GanttCorrectTask:
        'The task violates its constraints, do you want to move it?',
      GanttDeleteDependencies:
        'There are %d dependencies, do you want to delete them?',
      GanttCircularDependencies:
        'It will cause circular dependency relation. Do you want to create it anyway?',
      GanttCircularDependenciesErr:
        'It is not possible to create circular dependency relation',
      ...
      GanttCheckExclude:
        'The object starts on holiday, do you want to move it to the right?',
      ...
      V6_6: '',
      GanttCheckExcludeBack:
        'The object ends on holiday, do you want to move it to the left?',
      ...
      V7_0: '',
      ErrDateLow:
        'The date cannot be before <em><b>%1</b></em> due <b>%2</b> constraint',
      ErrDateHigh:
        'The date cannot be after <em><b>%1</b></em> due <b>%2</b> constraint',
      ...
      GanttCorrectExclude:
        'The object starts or ends on holiday, do you want to correct it?',
      V9_2: '',
    ...
    MenuCell: {
      ...
      CopySelectedEmptyChildEnd1:
        'Add selected empty row tree as the last child',
      ...
      CopySelectedEmptyEndPage1:
        'Add selected empty row tree to the end of page',
      CopySelectedEmptyEndGrid1:
        'Add selected empty row tree to the end of grid',
      ...
      CopySelectedEmptyChild:
        'Add %1 selected empty row trees as the first children',
      CopySelectedChildEnd: 'Copy %1 selected rows as the last children',
      CopySelectedTreeChildEnd:
        'Copy %1 selected row trees as the last children',
      CopySelectedEmptyChildEnd:
        'Add %1 selected empty row trees as the last children',
      ...
      CopySelectedEmptyEndPage:
        'Add %1 selected empty row trees to the end of page',
      CopySelectedEmptyEndGrid:
        'Add %1 selected empty row trees to the end of grid',
      ...
      ChooseBorderColorItems:
        "<span style='background:%2;padding-left:15px;margin-right:5px;border-radius:50px;'></span>%1",
      ...
      ChooseTextLineItems:
        "<span style='text-decoration:%1 line-through;'>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</span>",
      SetPattern: 'Set background pattern',
      NoPattern: 'No background pattern',
      ChoosePattern: 'Choose background pattern',
      ChoosePatternItems:
        "<span style='background-image:%1;padding-left:50px;line-height:16px;font-size:16px;'></span>",
    ...
    MenuPrint: {
      ...
      PrintPageOptions:
        "Page size<div style='font-size:10px;color:#EA4647;white-space:normal;'>Set&nbsp;the&nbsp;same&nbsp;values&nbsp;also in&nbsp;the&nbsp;browser&nbsp;print&nbsp;dialog!</div>",
  ...
  Toolbar: {
    ...
    AddChildTip:
      'Add new child row or move or copy selected rows to actual cursor position',
    ...
    SetLinkTip:
      'Add or clear hyperlink in the cell or for selected text in cell',
    ...
    DefSortTip: 'Restore original sorting',
    SortButtonText: 'Sort',
    ...
    LockTip2:
      'Grid structure, cell styles and formulas are locked, cell values are unlocked',
