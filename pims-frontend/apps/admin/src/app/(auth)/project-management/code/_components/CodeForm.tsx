...
import { Combobox } from '@pims-frontend/ui/components/ui/select'
...
export type UserBaseInfo = z.infer<typeof CodeFormSchema>

export type CodeFormProps = {
  defaultValues: UserDetailResDto | null
}

export const CodeForm = forwardRef<HTMLFormElement, CodeFormProps>(
  function WrappedCodeForm(props, ref) {
